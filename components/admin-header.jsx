...
const AdminHeader = ({siteInfos}) => {
  ...
  return (
    <div className="flex w-screen px-5 z-50 bg-white dark:bg-[#131418] border-b fixed top-0 left-0 border-gray-200 dark:border-zinc-600 justify-between items-center  p-2 gap-6 md:gap-10 ">
      ...
      <button               className="py-2 rounded-lg flex gap-x-3 items-center justify-center px-3 mx-auto disabled:opacity-50  w-3/4 sm:w-1/2 bg-yellow-200 hover:bg-yellow-300 dark:hover:bg-yellow-600 dark:bg-yellow-500"
 onClick={() =>{ 
  signOut(auth)
