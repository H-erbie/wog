...
<h3 className="sm:text-2xl text-[#F53D3D] capitalize text-center sm:text-left text-xl mb-9 ml-6 font-bold">
        {timeline} {" "}
      </h3>
        <Carousel
          opts={{
        ...
        >
          ...
          <CarouselContent className="border-none  h-80">
            {events.map((event) => (
              <CarouselItem  key={event.id} className=" md:basis-1/2 basic-3/4 sm:basis-[60%] lg:basis-1/3 w-full transition-all px-3 border-none  ">
                <div
     ...
     relative"
                ...
                >
                  <Image
                    ...
                    className="w-3/4 bg-red-200  rounded-3xl mx-auto object-cover"
                  />
                  ...
                  <div className=" w-[70%] event-desc transition-all left-[15%] gap-y-3 absolute bg-white -bottom-10 p-3 flex flex-col rounded-xl">
                    ...
                    <Sheet>
                      <SheetTrigger asChild>
                        <p className="ml-auto w-max hover:underline">
