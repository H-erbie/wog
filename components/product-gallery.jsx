        ...
        <ul className="grid w-max grid-cols-3  gap-x-5">
          {product.images.map((image, index) => {
            ...
            <div
              ...
              className={`relative  flex ${index == selectedImage ? 'h-16 w-16' : 'h-12 w-12'}  cursor-pointer items-center justify-center rounded-md bg-white text-sm font-medium uppercase hover:bg-gray-50`}
            >
             ...
             { !index == selectedImage && <span
                  className="pointer-events-none h-16 w-full absolute top-0 left-0  hover:backdrop-brightness-50"
