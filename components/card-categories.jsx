    ...
    <div className="container h-max sm:h-max border-[0.01px] dark:border-zinc-700 border-gray-200 rounded-lg my-3 py-2 px-0">
       <Carousel
        ...
        {filterdProducts.splice(0, 12).map((product) => (
          ...
          >
            <CarouselItem
                className="lg:basis-1/6 md:basis-1/5 sm:basis-1/4 basis-1/3 w-full transition-all px-3 border-none  border"
              >
              <Link href={`/products/${product?.slug?.current}`}>
                ...
                >
                  ...
                  <div className="flex flex-col justify-evenly gap-y-2">
                    <span className="text-center">GHS {product.price}</span>
