...
const About = () => {
  ...
  return (
    <div className="p-5">
               <h3 className="sm:text-4xl text-center lg:text-left text-3xl mb-9 lg:ml-40 mx-auto lg:mx-0 w-52 font-bold">Hi<span className="text-[#F53D3D]">story</span> </h3>
 <div className='flex items-center lg:flex-row gap-8 flex-col-reverse'>
      ...
      <Image
        ...
        <h3 className="sm:text-4xl text-center lg:text-left text-3xl my-9 lg:ml-40 mx-auto lg:mx-0 w-52 font-bold">Miss<span className="text-[#F53D3D]">ion</span> </h3>
      ...
      <Image
        ...
        <h3 className="sm:text-4xl text-center lg:text-left text-3xl my-9 lg:ml-40 mx-auto lg:mx-0 w-52 font-bold">Tea<span className="text-[#F53D3D]">m</span> </h3>
