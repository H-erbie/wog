...
const Aim = () => {
  ...
  return (
   ...
   <h3 className="sm:text-4xl text-center lg:text-left text-3xl mb-9 lg:ml-40 mx-auto lg:mx-0 w-52 font-bold">Why we do <span className="text-[#F53D3D]">What we do</span> </h3>
